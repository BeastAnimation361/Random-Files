...
def main():
    ...
    title = input("Please Enter Index Title: ")
    pathToIndex = input("Please Enter Path To Index:")
        ...
        for file in files:
            ...
            if os.path.isfile(full_file_path):
                ...
                if '"' in file:
                    file = file.replace('"', '_')
                if file_size == 0:
                    print("Skipping File Because 0 Bytes")
                else:
